...
PalletObject::PalletObject(float x, float y, float z, dWorldID w, dSpaceID s)
{
    ...
    m_model.loadModel("Pallet.obj", 20);
...
void PalletObject::setPosition(float x, float y, float z)
{
